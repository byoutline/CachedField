...
class MockCFWithArg implements CachedFieldWithArg<String, Integer> {
    ...
    @Override
    void addEndpointListener(@Nonnull EndpointStateListener<String, Integer> listener) {
    }

    @Override
    boolean removeEndpointListener(@Nonnull EndpointStateListener<String, Integer> listener) {
        return false
    }
}

...
fun <RETURN_TYPE : Any, ARG_TYPE> CachedFieldWithArg<RETURN_TYPE, ARG_TYPE>.postToRx(arg: ARG_TYPE?)
        : rx.Single<CachedFieldResultAndArg<RETURN_TYPE, ARG_TYPE?>> {
    return CachedEndpointAlwaysPostCompat(this).postToRx(arg)
}

fun <RETURN_TYPE : Any> CachedField<RETURN_TYPE>.postToRx(): rx.Single<RETURN_TYPE> {
    return toCachedFieldWithArg().postToRx(null).map { it.result }
}

fun <RETURN_TYPE : Any, ARG_TYPE> CachedEndpointWithArg<RETURN_TYPE, ARG_TYPE>.postToRx(arg: ARG_TYPE?)
        : rx.Single<CachedFieldResultAndArg<RETURN_TYPE, ARG_TYPE?>> {
